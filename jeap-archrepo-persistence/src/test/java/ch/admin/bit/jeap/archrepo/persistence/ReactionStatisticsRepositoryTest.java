...
class ReactionStatisticsRepositoryTest {
    ...
    void getMaxLastModifiedAtList() {
        ...
        BackendService componentC = BackendService.builder()
                ...
                .createdAt(ZonedDateTime.now())
                .build();
        systemA.addSystemComponent(componentC);
        ...
        Action action4 = Action.builder()
                .actionType("actionType4")
                .actionFqn("com.example.Action4")
                .build();
        ReactionStatistics statistics4 = ReactionStatistics.builder()
                .component(componentC)
                .triggerType("triggerType1")
                .triggerFqn("com.example.TriggerD")
                .count(40)
                ...
                .percentage(80.0)
                .build();
        statistics4.addAction(action4);
        repository.save(statistics4);

        List<ReactionStatisticsLastModifiedAt> components = repository.getMaxLastModifiedAtList();
        assertThat(components).hasSize(3);

        assertThat(components.getFirst().getComponent()).isEqualTo(componentA.getName());
        assertThat(components.getFirst().getLastModifiedAt()).isEqualTo(ReflectionTestUtils.getField(statistics1, "modifiedAt"));
        assertThat(components.get(1).getComponent()).isEqualTo(componentB.getName());
        assertThat(components.get(1).getLastModifiedAt()).isEqualTo(ReflectionTestUtils.getField(statistics2, "modifiedAt"));
        assertThat(components.getLast().getComponent()).isEqualTo(componentC.getName());
        assertThat(components.getLast().getLastModifiedAt()).isEqualTo(ReflectionTestUtils.getField(statistics4, "modifiedAt"));
